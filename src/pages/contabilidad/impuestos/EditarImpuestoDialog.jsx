...
const EditarImpuestoDialog = ({ open, onClose, impuesto, onImpuestoActualizado }) => {
  ...
  useEffect(() => {
    if (impuesto) {
      setValue('titulo_impuesto', impuesto.titulo_impuesto);
      setValue('tipo_obligacion', impuesto.tipo_obligacion || '');
      setValue('institucion_reguladora', impuesto.institucion_reguladora || '');
      setValue('formula_aplicacion', impuesto.formula_aplicacion || '');
      setValue('oportunidades_optimizacion', impuesto.oportunidades_optimizacion || '');
      setValue('periodicidad_declaracion', impuesto.periodicidad_declaracion || '');
      setValue('fecha_fin', formatearFecha(impuesto.fecha_fin));
      setValue('estado', impuesto.estado || 'ACTIVO');
      setValue('observaciones', impuesto.observaciones || '');
      setValue('url_referencia_normativa', impuesto.url_referencia_normativa || '');
      setValue('fecha_inicio_impuesto', formatearFecha(impuesto.fecha_inicio_impuesto));
      setValue('fecha_final_impuesto', formatearFecha(impuesto.fecha_final_impuesto));
      setValue('url_instrucciones', impuesto.url_instrucciones || '');
    }
  }, [impuesto, setValue]);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response.ok) {
        toast({ title: "Éxito", description: "Impuesto actualizado correctamente" });
      ...
      toast({ title: "Error", description: "No se pudo actualizar el impuesto", variant: "destructive" });
    }
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Modifique los datos del impuesto seleccionado
              </p>
            </div>
          </div>
        </DialogHeader>
...
export default EditarImpuestoDialog; 