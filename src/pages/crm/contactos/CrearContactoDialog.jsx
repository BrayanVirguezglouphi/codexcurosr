...
const CrearContactoDialog = ({ open, onClose, onContactoCreado }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const contacto = await apiCall('/api/crm/contactos', {
        method: 'POST',
        headers: {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete la información para registrar una nueva persona de interés en el CRM
          </DialogDescription>
        </DialogHeader>
...
export default CrearContactoDialog; 