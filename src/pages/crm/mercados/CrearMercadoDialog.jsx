...
const CrearMercadoDialog = ({ open, onClose, onMercadoCreado }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const mercado = await apiCall('/api/crm/mercados', {
        method: 'POST',
        headers: {
      ...
      reset();
      onMercadoCreado?.(mercado);
      onClose();
    } catch (error) {
      console.error('Error al crear mercado:', error);
      toast({
        title: "Error",
        description: error.message || "Error al crear el mercado",
        variant: "destructive"
      });
    }
  };
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete la información para agregar un nuevo mercado al sistema
          </DialogDescription>
        </DialogHeader>
...
export default CrearMercadoDialog; 